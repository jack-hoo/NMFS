...
public class SysMenuEntity implements Serializable {
    ...
    /*public static List<SysMenuEntity> getMenuTree(List<SysMenuEntity> menuList , Long parent){
        List<SysMenuEntity> menus = new ArrayList<>();
        for (SysMenuEntity menu : menuList){
            SysMenuEntity node = new SysMenuEntity();
            if (menu.getParentId() == parent){
                List<SysMenuEntity> menuNodes = getMenuTree(menuList ,menu.getMenuId());
                node = menu;
